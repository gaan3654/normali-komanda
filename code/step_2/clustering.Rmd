...
How many principal components would it take in order to capture 90% of the variance in the data?
It would take `r table(cumsum(prComponent$sdev^2)/sum(prComponent$sdev^2) > 0.9)["FALSE"]` principal components.
